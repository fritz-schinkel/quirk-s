...
import {Stateogram} from "./Stateogram.js"
...
class DisplayedInspector {
     ...
     * @param {!Stateogram} stateogram
     * @param {!Hand} hand
     */
    constructor(drawArea, circuitWidget, displayedToolboxTop, histogram, stateogram, hand) {
    ...
    updateArea(drawArea) {
        ...
        this.stateogram = this.stateogram.withTop(
            this.displayedCircuit.top + this.displayedCircuit.desiredHeight()
        );
        this.histogram = this.histogram.withTopLeft(
            this.displayedCircuit.top + this.displayedCircuit.desiredHeight(),
            this.stateogram.desiredWidth()
        );
    }
    ...
    static empty(drawArea) {
        ...
        let stateogram = new Stateogram(displayedCircuit.desiredHeight());
    ...
    paint(painter, stats) {
        ...
        this.stateogram.paint(painter, stats, this.hand);
