...
const DeutschJoszaLink ={
    ...
    "gates":[
        {"id":"~itcg","name":"Alice_1","circuit":{"cols":[["X",1,1,1,1,"•"],["X",1,1,1,1,"•"]]}},
        {"id":"~3kd","name":"Alice_2","circuit":{"cols":[["X",1,1,1,1,"•"],["X"],["X",1,1,1,1,"•"]]}},
        {"id":"~27pm","name":"Alice_3","circuit":{"cols":[["X","•"],["X",1,"•"],["X",1,1,"•"],["X",1,1,1,"•"],["X",1,1,1,1,"•"]]}},
        {"id":"~dat1","name":"Alice_4","circuit":{"cols":[["X","•"],["X",1,1,"•","•"],["X",1,1,1,"•","•"],["X",1,"•","•"],["X",1,1,"•",1,"•"]]}}
    ],
    "init":[1]
};
...
function initGallery(revision, obsIsAnyOverlayShowing) {
    ...
    const deutschJoszaAnchor = /** @type {!HTMLAnchorElement} */ document.getElementById('example-deutsch-josza');
    ...
    for (let [a, t] of [[groverAnchor, groverLink],
                        ...
                        [deutschJoszaAnchor, DeutschJoszaLink]]) {
