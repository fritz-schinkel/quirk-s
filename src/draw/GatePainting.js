...
GatePainting.MAKE_HIGHLIGHTED_DRAWER =
    (toolboxFillColor = Config.GATE_FILL_COLOR, normalFillColor = Config.GATE_FILL_COLOR) => args => {
        ...
        let usedColor = Config.DEFAULT_GATE_COLOR;
        let usedHighLight = Config.DEFAULT_GATE_HIGHLIGHT;
...
const DISPLAY_GATE_DEFAULT_DRAWER = GatePainting.MAKE_HIGHLIGHTED_DRAWER(Config.DEFAULT_GATE_COLOR);
